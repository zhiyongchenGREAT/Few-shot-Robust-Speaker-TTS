...
parser.add_argument('--finetune-data-split', type=str, default='./data/ESD/train1_full_controlling(14)')
parser.add_argument('--evaluation-data-split', type=str, default='./data/ESD/test1')
...
def main_worker(options):
    ...
    train_root = options['finetune_data_split']
    ...
    Data = SpeakerDataloader(known=list(range(num_speakers)), train_root=options['finetune_data_split'], 
